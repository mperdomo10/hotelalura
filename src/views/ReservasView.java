...
public class ReservasView extends JFrame {
	...
	//private Object txtValor.getText();
	...
	private void guardarReserva() {
		String fechaen = ((JTextField)txtFechaEntrada.getDateEditor().getUiComponent()).getText();
		String fechasa = ((JTextField)txtFechaSalida.getDateEditor().getUiComponent()).getText();
		Reserva nuevaReserva= new Reserva(java.sql.Date.valueOf(fechaen),java.sql.Date.valueOf(fechasa),txtValor.getText(),txtFormaPago.getSelectedItem().toString());
