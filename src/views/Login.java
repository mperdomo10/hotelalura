...
public class Login extends JFrame {
	...
	public Login() {
		...
		JTextArea txtrRegistrarNuevoUsuario = new JTextArea();
		txtrRegistrarNuevoUsuario.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Registrauser registrauser = new Registrauser();
				registrauser.setVisible(true);
				dispose();
			}
		});
		txtrRegistrarNuevoUsuario.setFont(new Font("DejaVu Sans Light", Font.BOLD | Font.ITALIC, 12));
		txtrRegistrarNuevoUsuario.setText("Registrar nuevo usuario");
		txtrRegistrarNuevoUsuario.setBounds(65, 486, 163, 22);
		panel.add(txtrRegistrarNuevoUsuario);
	}
	...
	private void Login() {
	     ...
	     Connection con=factory.recuperarConexion();
			...
			try {
		       ...
		       statement.setString(2, contrase);
